...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002160257812'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002160257812'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002291269785')  # Channel/Group ID for force sub (make sure bot is admin)
