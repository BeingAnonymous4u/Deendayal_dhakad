...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6246830040 6941610925').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002075903430 -1002208295766').split()]  # Channel id for auto indexing (make sure bot is admin)
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002345681830'))  # Notification of those who verify will be sent to your channel
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002021217229').split()]
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://herukoid1:GNli5O0mVUA4DPVjcluster0.rqded.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
